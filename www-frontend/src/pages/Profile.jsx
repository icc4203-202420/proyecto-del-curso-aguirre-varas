...
const Profile = () => {
  ...
  return (
    <Box sx={{ marginTop: 7, marginBottom: 7, padding: 3, bgcolor: "#3b1e0e", color: "#FFD597", minHeight: "100vh" }}>
      
      <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", mb: 2 }}>
        <Avatar sx={{ width: 120, height: 120, bgcolor: "#e5b886" }} alt="Profile Picture" />
      </Box>

      <Typography variant="h5" align="center" gutterBottom>
        Joaquín Varas
      </Typography>
      <Typography variant="body1" align="center" color={palette.lager} gutterBottom>
        @joaco_varas
      </Typography>
      ...
      <Box sx={{ display: "flex", justifyContent: "center", alignItems: "flex-end", mb: 2 }}>
        {barHeights.map((height, index) => (
          <Box key={index} sx={{ width: 15, height, bgcolor: "brown", mx: 0.5 }} />
        ))}
      </Box>
